...
- (NSString *)base64EncodedString
{
    size_t outputLength;
    char *outputBuffer =
    PoemNewBase64Encode([self bytes], [self length], true, &outputLength);
    NSString *result =
    [[NSString alloc]
...
- (NSString *)base64EncodedStringWithSeparateLines:(BOOL)separateLines
{
    size_t outputLength;
    char *outputBuffer =
    PoemNewBase64Encode([self bytes], [self length], separateLines, &outputLength);
    NSString *result =
    [[NSString alloc]
     initWithBytes:outputBuffer
     length:outputLength
